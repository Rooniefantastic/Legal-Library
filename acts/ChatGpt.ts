...
export const chatgpt: Act = {
  act_name: "The Bharatiya Vayuyan Adhiniyam, 2024 (ACT NO. 16 OF 2024)",
  preamble: {
    title: "An Act to provide for regulation and control of the design, manufacture, maintenance, possession, use, operation, sale, export and import of aircraft and for matters connected therewith or incidental thereto.",
    text:
  ...
  chapters: [
          ...
          footnotes: [
            {
              fn_number: "1",
              text:
                "1ST January, 2025, vide notification NO. S.O. 5646(E), dated 31st December, 2024, see Gazette of India, Extraordinary, Part II, sec. 3(ii)."
            }
          ]
        },
        {
    ...
    {
      chapter_number: "II",
      chapter_title: "DIRECTORATE GENERAL OF CIVIL AVIATION",
      section_range: "3-4",
      sections: [
        {
          section_number: "3",
          section_title: "Directorate General of Civil Aviation.",
          text:
        ...
        {
          section_number: "4",
          section_title: "Power of Director General of Civil Aviation to issue directions.",
          text:
    ...
    {
      chapter_number: "III",
      chapter_title: "BUREAU OF CIVIL AVIATION SECURITY",
      section_range: "5-6",
      sections: [
        {
          section_number: "5",
          section_title: "Bureau of Civil Aviation Security.",
          text:
        ...
        {
          section_number: "6",
          section_title: "Power of Director General of Bureau of Civil Aviation Security to issue directions.",
          text:
    ...
    {
      chapter_number: "IV",
      chapter_title: "AIRCRAFT ACCIDENTS INVESTIGATION BUREAU",
      section_range: "7",
      sections: [
        {
          section_number: "7",
          section_title: "Aircraft Accidents Investigation Bureau.",
          text:
    ...
    {
      chapter_number: "V",
      chapter_title: "POWERS OF CENTRAL GOVERNMENT",
      section_range: "8-21",
      sections: [
        {
          section_number: "8",
          section_title: "Superintendence of Central Government.",
          text:
        ...
        {
          section_number: "9",
          section_title: "Power of Central Government to review orders passed under section 4 or section 6.",
          text:
        ...
        {
          section_number: "11",
          section_title: "Power of Central Government to make rules to implement Convention.",
          text:
        ...
        {
          section_number: "12",
          section_title: "Power of Central Government to make rules for investigation of accidents.",
          text:
        ...
        {
          section_number: "13",
          section_title: "Power of Central Government to make rules for protecting public health.",
          text:
        ...
        {
          section_number: "14",
          section_title: "Emergency powers of Central Government for protecting public health.",
          text:
        ...
        {
          section_number: "15",
          section_title: "Power of Central Government to make orders in emergency.",
          text:
        ...
        {
          section_number: "16",
          section_title: "Power of Central Government to make rules for securing safe custody and re-delivery of unclaimed property.",
          text:
        ...
        {
          section_number: "17",
          section_title: "Power to detain aircraft.",
          text:
        ...
        {
          section_number: "18",
          section_title: "Power of Central Government to prohibit or regulate construction of buildings, planting of trees, and the like.",
          text:
        ...
        {
          section_number: "19",
          section_title: "Power of Central Government to restrict, suspend or cancel licence, certificate or approval.",
          text:
        ...
        {
          section_number: "20",
          section_title: "Power of Central Government to exempt certain aircraft.",
          text:
        ...
        {
          section_number: "21",
          section_title: "Power of Central Government to delegate.",
          text:
    ...
    {
      chapter_number: "VI",
      chapter_title: "PAYMENT OF COMPENSATION FOR LOSS OR DAMAGE",
      section_range: "22-24",
      sections: [
        {
          section_number: "22",
          section_title: "Manner of determination and payment of compensation for loss or damage.",
          text:
        ...
        {
          section_number: "23",
          section_title: "Appeal from award in respect of compensation.",
          text:
        ...
        {
          section_number: "24",
          section_title: "Arbitrator to have certain powers of civil courts.",
          text:
    ...
    },
    {
      ...
      sections: [
        {
          section_number: "25",
          section_title: "Penalty for contravention of rule made under this Act.",
          text:
        ...
        {
          section_number: "26",
          section_title: "Penalty for flying so as to cause danger.",
          text:
        ...
        {
          section_number: "27",
          section_title: "Penalty for failure to comply with directions issued under section 4 or section 6.",
          text:
        ...
        {
          section_number: "28",
          section_title: "Penalty for failure to comply with directions issued under section 18.",
          text:
        ...
        {
          section_number: "29",
          section_title: "Penalty for abetment of offences and attempted offences.",
          text:
        ...
        {
          section_number: "30",
          section_title: "Composition of offences.",
          text:
        ...
        {
          section_number: "32",
          section_title: "Adjudication of penalties.",
          text:
            ...
            "Provided further that the designated officer shall not proceed for imposition of penalty under sub-section (4), if an action under this Act other than the imposition of such penalty has been initiated for contravention of same provision on the same cause of action."
        },
        {
          section_number: "33",
    ...
    },
    {
      ...
      sections: [
        {
          section_number: "34",
          section_title: "Rules to be made after publication.",
          text:
        ...
        {
          section_number: "35",
          section_title: "Laying of rules before Parliament.",
          text:
        ...
        {
          section_number: "36",
          section_title: "Power of Court to order forfeiture.",
          text:
        ...
        {
          section_number: "37",
          section_title: "Wreck and salvage.",
          text:
        ...
        {
          section_number: "38",
          section_title: "Use of patented invention on aircraft not registered in India.",
          text:
        ...
        {
          section_number: "39",
          section_title: "Bar of certain suits.",
          text:
        ...
        {
          section_number: "40",
          section_title: "Protection of action taken in good faith.",
          text:
        ...
        {
          section_number: "41",
          section_title: "Savings of application of Act.",
          text:
        ...
        {
          section_number: "42",
          section_title: "Power to remove difficulty.",
          text:
  ...
  statement_of_objectives_and_reasons: {
    title: "STATEMENT OF OBJECTS AND REASONS",
    text:
      "The Aircraft Act, 1934 (22 of 1934) was enacted to make better provision for the control of the manufacture, possession, use, operation, sale, import and export of aircraft.\\n\\n" +
      "2. The regulation of civil air transport within the territory and the airspace above India, including regulation of international air services of national and foreign air carriers is the sovereign function of the Government of India and the same is given effect to under this Act, having regard to the international regulations, bilateral and multilateral agreements and arrangements to which India is a contracting party or which has been acceded to or ratified by India.\\n\\n" +
      "3. The Aircraft Act, 1934 has been amended several times to enhance safety, oversight and to meet requirements for sustainable growth of aviation sector and to give effect to the provisions of international conventions. As a result of numerous amendments over a period of ninety years, a need is felt to address the ambiguities and confusion experienced by the stakeholders, to remove redundancies, to enable ease of doing business and to provide for manufacture and maintenance in the aviation sector and to re-enact the aforesaid Act in the form of a Bill, namely, the Bharatiya Vayuyan Vidheyak, 2024.\\n\\n" +
      "4. The Bharatiya Vayuyan Vidheyak, 2024, inter alia, seeks to––\\n\\n" +
      "(a) provide for design, manufacture and maintenance of aircraft and related equipment;\\n\\n" +
      "(b) empower the Central Government to regulate issuance of Radio Telephone Operator (Restricted) Certificate and licence to provide for ease of business;\\n\\n" +
      "(c) empower the Central Government to make rules to implement the Convention relating to international civil aviation and the other matters relating to civil aviation security;\\n\\n" +
      "(d) empower the Central Government to issue orders in emergency in the interest of public safety or tranquility;\\n\\n" +
      "(e) provide for payment of compensation for loss or damage in such manner as provided under the Act;\\n\\n" +
      "(f) provide for appeal against the matters relating to compensation, licence, certificate or approval and adjudication of penalties;\\n\\n" +
      "(g) provide for imprisonment, fine or penalties for contravention of the provisions of the Act or the rules made thereunder;\\n\\n" +
      "(h) remove ambiguities and redundancies;\\n\\n" +
      "(i) provide for repeal of the Aircraft Act, 1934 and saving of acts done under the said Act; and\\n\\n" +
      "(j) other regulatory provisions for effective implementation of the proposed legislation.\\n\\n" +
